...
import { Ban, CheckCircle2, ChevronLeft, ChevronRight, Copy, Eye, KeyRound, Loader2, Mail, MoreHorizontal, PauseCircle, Pencil, Phone, RefreshCw, Search, ShieldAlert, Trash2 } from "lucide-react";
      ...
      <Card><CardContent className="p-0">
        {loading ? <div className="grid min-h-64 place-items-center"><Loader2 className="h-7 w-7 animate-spin text-muted-foreground" /></div> : items.length === 0 ? (
          ...
          <TableBody>{items.map((item) => <TableRow key={item.id}>
            ...
            <TableCell className="text-center"><div className="flex items-center justify-center gap-4">
